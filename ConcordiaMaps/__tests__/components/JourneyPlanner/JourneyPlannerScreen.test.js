...
jest.mock("../../../components/JourneyPlanner/LocationTitleInput", () => "LocationTitleInput");
...
jest.mock("../../../components/JourneyPlanner/BuildingRoomSelector", () => {
  ...
  const MockedBuildingRoomSelector = (props) => {
    ...
    return React.createElement("BuildingRoomSelector", { ...props, testID: props.testID || "building-room-selector" });
  };
...
jest.mock("../../../components/JourneyPlanner/AddressSelector", () => {
  ...
  const MockedAddressSelector = (props) => {
    // Ensure testID is passed through
    return React.createElement("AddressSelector", { ...props, testID: props.testID || "address-selector" });
  };
  MockedAddressSelector.displayName = "AddressSelector";
  return MockedAddressSelector;
});

jest.mock("../../../components/JourneyPlanner/LocationsSection", () => "LocationsSection");
jest.mock("../../../components/JourneyPlanner/PreferencesSection", () => "PreferencesSection");
jest.mock("../../../components/JourneyPlanner/GenerateButton", () => "GenerateButton");
...
describe("JourneyPlannerScreen", () => {
  ...
  it("changes input mode and renders appropriate components", () => {
    const { getByTestId, queryByTestId, UNSAFE_root } = render(<JourneyPlannerScreen />);
  ...
  it("handles address selection correctly", () => {
    ...
    const testLocation = { latitude: 45.496, longitude: -73.578, title: "Test Location" };
  ...
  it("allows moving tasks up and down", () => {
     ...
     useJourneyPlanner.mockReturnValueOnce({
       ...
       tasks: [
         { title: "Task 1", latitude: 45.496, longitude: -73.578 },
         { title: "Task 2", latitude: 45.497, longitude: -73.579 },
         { title: "Task 3", latitude: 45.498, longitude: -73.580 }
       ],
       addAddressTask: mockAddAddressTask,
       addBuildingRoomTask: mockAddBuildingRoomTask,
       removeTask: mockRemoveTask,
