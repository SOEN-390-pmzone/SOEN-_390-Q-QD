      ...
      >
        ...
        <View style={styles.inputTypeContainer}>
          <TouchableOpacity
            style={[
              styles.tabButton,
              inputMode === "address" && styles.activeTab,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.tabButton,
              inputMode === "building" && styles.activeTab,
            ]}
        ...
        <View style={styles.preferencesContainer}>
          ...
          >
            ...
            <View
              style={[styles.checkbox, avoidOutdoor && styles.checkboxChecked]}
            >
              {avoidOutdoor && (
        ...
        <TouchableOpacity
          style={[
            ...
            tasks.length < 2 && styles.disabledButton,
          ]}
